...
#define MT9V03X_1_EXP_TIME_DEF    ( 80  )                                           // 总钻风摄像头1 曝光时间       摄像头收到后会自动计算出最大曝光时间，如果设置过大则设置为计算出来的最大曝光值
...
#define MT9V03X_1_GAIN_DEF        ( 16  )                                           // 总钻风摄像头1 图像增益       范围 [16-64]  增益可以在曝光时间固定的情况下改变图像亮暗程度
